...
public class scrEdit_objectTilePositionUtility : ScriptableWizard
{
    ...
    // add menu item
    [MenuItem("ZerinLabs/Object Tile-Positionining utility")]

    //-----------------------------------------------------------------------------------------------------------------
    static void Init()
    {
        scrEdit_objectTilePositionUtility window = (scrEdit_objectTilePositionUtility)EditorWindow.GetWindow(typeof(scrEdit_objectTilePositionUtility));
        window.Show();
    }
